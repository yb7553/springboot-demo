...
import com.swan2boot.swan.env.service.BlogProperties;
...
public class SwanEnvServiceApplicationTests {

	private static final Log log = LogFactory.getLog(SwanEnvServiceApplicationTests.class);
